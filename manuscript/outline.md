...
- [support] An augmented change model additionally controlled for the 2017 baseline rating, testing whether the baseline rating was associated with the subsequent change. `[data: ../methods.md §7]`
...
- [core] Topic sentence: the 2,380 hospitals spanned ownership types and rural-urban settings, and several factors shifted between 2017 and 2024. `[table 1]`
...
- [core] Headline shifts: mean overall rating fell 3.45 → 3.27 stars; median ED time fell 292 → 181 minutes. Report both figures plainly, with no comparability caveat in this section (the ED measure-scope caveat is made once, in Limitations ¶21). `[data: ../findings.md §3; table 1]`
- [support] Between-year shifts in the panel's county mix: mean share White fell about 11 percentage points and mean median household income rose about $12,800. State these as the panel's observed between-year shifts and **stop there** — give the numbers, draw no inference here; the likely sample-composition explanation is given once, in Limitations (¶21). `[data: ../findings.md §8 flag 4]`
- [core] Geographic pattern (Figure 1): rating gains and losses appeared across the country, but improvement concentrated in three areas — Appalachia, Florida, and the West Coast — with gains and declines more intermixed elsewhere. Much of the sparsely populated interior West is unshaded (no sampled hospital reported a rating there in both years). `[figure 1; data: ../findings.md §7]`
...
- [support] *Transition:* these are the aggregate and geographic shifts; the regressions show what is associated with the rating itself.
...
- [core] Topic sentence: the factors significantly associated with the overall star rating were largely the same in 2017 and 2024, and the direction of each association held across the two years even as the national mean fell. `[table 2, columns 1–2; data: ../findings.md §4]`
- [core] Hospital-level factors (direction and significance): by ownership, government hospitals scored highest and non-profit hospitals lowest, with for-profit hospitals near government in 2017 and modestly below by 2024; by rurality, small rural hospitals scored highest — above urban hospitals in both years — while large rural hospitals, below urban in 2017, were level with them by 2024; and a longer median ED time was associated with a lower rating. `[data: ../findings.md §4; table 2]`
- [core] County-level factors (direction and significance): higher ratings were associated with more hospitals per 1,000 residents, a higher prevalence of self-reported poor health, and a higher share holding a bachelor's degree or above; lower ratings were associated with higher shares aged 65 and over, foreign-born, and in poverty (including poverty among adults 65 and over). `[data: ../findings.md §4; table 2]`
- [core] One association ran against expectation: the positive sign on self-reported poor health — higher county poor-health prevalence was associated with *higher* ratings in both years — flagged here and taken up in the Discussion. `[data: ../findings.md §4, §8 flag 1]`
- [support] *Transition:* almost none of these factors, however, was associated with the 2017→2024 *change* in rating.
...
- [core] Topic sentence: in contrast to the broad set of factors associated with rating *levels*, only a few were associated with the 2017→2024 *change* — among the time-varying factors, the change in ED time and the change in median household income; and among the time-invariant factors, ownership and rural-urban classification. `[table 2, columns 3–4]` <!-- OR-3 -->
...
- [core] No other county shift was associated with rating change: changes in age structure, racial composition, foreign-born share, education, and poverty were all unrelated to it — shifts in population composition do not explain the shift in ratings. `[data: ../findings.md §5]`
- [support] Among the time-invariant factors, rural hospitals gained relative to urban (large rural +0.20, small rural +0.28 stars), and for-profit and non-profit hospitals declined more than government hospitals. `[data: ../findings.md §5; table 2]`
