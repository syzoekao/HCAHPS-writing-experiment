...
- [core] Reputational stake: because Care Compare publishes the star ratings on a consumer-facing site, ratings also feed prospective patients' hospital-choice decisions and the hospital's reputation independent of any payment formula `[@HttpsWwwmedicaregovCarecompare; @popeReactingRankingsEvidence2009; @gutackerChoiceHospitalWhich2016]`.
