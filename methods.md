...
- **Timely and Effective Care — Hospital** (CMS Care Compare), 2017 and 2024 vintages. Used to extract the *Average (median) time all patients spent in the emergency department before leaving from the visit, including psychiatric/mental health patients and patients who were transferred to another facility* — our emergency department (ED) throughput measure. Processed in [stata/do.do](stata/do.do); saved as `timeliness.dta` (2024) and `timeliness2017.dta` (2017). *Validation pending:* the 2017 and 2024 vintages of this measure may not be directly comparable if the underlying OP-18b specification changed across the window (analyst flag, 2026-05-22). See [findings.md §8 flag 3](findings.md#8-notes-and-flags) for the validation plan.
